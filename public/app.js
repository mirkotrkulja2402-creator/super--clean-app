...
function loginView(error = "") {
    ...
    document.getElementById("password-toggle")?.addEventListener("click", () => {
        ...
        button.innerHTML = visible ? scIcon("search") : scIcon("admin");
        ...
        <div class="sc-home-app">
            <header class="sc-app-header">
                ...
                <div class="sc-header-brand">
                    <img src="/super-clean-logo-transparent.png" alt="Super Clean Banja Luka">
...
function homeContent() {
    const items = [
        ...
        ["quick", "Brzi unos", "Brz i jednostavan unos", "orders.view", "orders"],
        ["gari", "Gari", "Evidencija Gari usluga", "orders.view", "gari"],
        ...
        ["map", "Mapa / Dostava", "Lokacije i dostava", "orders.view", "map"],
        ["truck", "Vozila", "Vozila i vozači", "orders.view", "vehicles"],
    ...
    return `
        <div class="sc-home-page">
            <section class="sc-home-hero">
                ...
                <img class="sc-home-hero-logo" src="/super-clean-logo-transparent.png" alt="Super Clean Banja Luka">
            </section>
